...
PaperVault is a security-sensitive tool. Please keep contributions small, well-tested, and careful with anything that touches encryption, key generation, QR output, printing, or vault recovery.
...
3. Make your changes.
4. Test locally.
5. Commit your changes using the Conventional Commits format (e.g. `feat(scope):`, `fix(scope):`, `docs:`).
